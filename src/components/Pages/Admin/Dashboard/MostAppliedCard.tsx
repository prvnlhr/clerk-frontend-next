    ...
    <div className="w-[15%] h-[60%] flex flex-col justify-start items-start gap-y-4 rounded-[15px] p-[10px] border border-gray-200
       ...
       <div className="w-full h-[auto] flex flex-col justify-start items-start">
            ...
            <div className="w-full h-[auto] flex justify-start items-center">
                    <p className="font-medium text-[1rem] line-clamp-1">DevOps Eng, Amazon</p>
            </div>
            {/* LINK TO JOBS PAGE------------------------------------------------------- */}
            <div className="w-full h-[auto] flex justify-start items-center">
...
export default MostAppliedCard;
